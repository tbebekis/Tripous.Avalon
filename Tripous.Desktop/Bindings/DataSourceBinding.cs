...
/// </summary>
public class DataSourceBinding: TripousBinding, IDisposable
{
    // ● private fields
    ...
    /// </summary>
    public DataSourceBinding(DataSource Source, Control Control, string FieldName, AvaloniaProperty TargetProperty, IDisposable Subscription, FieldDef FieldDef = null)
    {
        this.Source = Source;
    ...
    /// </summary>
    public DataSourceBinding(DataSource Source, DataGridColumn GridColumn, string FieldName, IDisposable Subscription, FieldDef FieldDef = null)
    {
        this.Source = Source;
