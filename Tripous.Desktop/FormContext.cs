...
public class FormContext
{
    ...
    static public FormContext Create(string ClassName, FormDisplayMode DisplayMode, Control Caller = null)
    {
        return FormContext.Create(ClassName, ClassName, DisplayMode, Caller);
    }
    static public FormContext Create(string FormId, string ClassName, FormDisplayMode DisplayMode, Control Caller = null)
    {
