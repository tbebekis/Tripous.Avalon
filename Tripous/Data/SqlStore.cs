...
public class SqlStore
{
    ...
    /// </summary>
    public DataTable Select(string SqlText) => Provider.Select(ConnectionInfo, SqlText);
    /// <summary>
    /// Executes a SELECT statement and returns the result as a DataTable.
    /// </summary>
    public DataTable Select(string SqlText, params object[] Params) => Provider.Select(ConnectionInfo, SqlText,  Params);
    /// <summary>
    /// Executes a SELECT statement inside a transaction and returns the result as a DataTable.
    /// </summary>
    public DataTable Select(DbTransaction Transaction, string SqlText, params object[] Params) => Provider.Select(Transaction, SqlText, ConnectionInfo.CommandTimeoutSeconds, Params);

    // ● SelectTo
    /// <summary>
    /// Executes a SELECT statement and loads the result into the specified DataTable.
    /// </summary>
    public int SelectTo(DataTable Table, string SqlText) => Provider.SelectTo(ConnectionInfo, Table, SqlText);
    /// <summary>
    /// Executes a SELECT statement and loads the result into the specified DataTable.
    /// </summary>
    public int SelectTo(DataTable Table, string SqlText, params object[] Params) => Provider.SelectTo(ConnectionInfo, Table, SqlText, ConnectionInfo.CommandTimeoutSeconds, Params);
    /// <summary>
    /// Executes a SELECT statement and loads the result into the specified DataTable using a transaction.
    /// </summary>
    public int SelectTo(DbTransaction Transaction, DataTable Table, string SqlText, params object[] Params) => Provider.SelectTo(Transaction, Table, SqlText, ConnectionInfo.CommandTimeoutSeconds, Params);
