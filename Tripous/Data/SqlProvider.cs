...
public abstract class SqlProvider
{
    ...
    /// </summary>
    public DataTable Select(DbConnectionInfo ConnectionInfo, string SqlText) => Select(ConnectionInfo, SqlText, null);
    /// <summary>
    /// Executes a SELECT statement and returns the result as a DataTable.
    /// </summary>
    public DataTable Select(DbConnectionInfo ConnectionInfo, string SqlText, params object[] Params) => Select(ConnectionInfo.ConnectionString, SqlText, ConnectionInfo.CommandTimeoutSeconds, Params);
    
    /// <summary>
    /// Executes a SELECT statement and returns the result as a DataTable.
    /// </summary>
    public DataTable Select(string ConnectionString, string SqlText) => Select(ConnectionString, SqlText, null);
    /// <summary>
    /// Executes a SELECT statement and returns the result as a DataTable.
    /// </summary>
    public DataTable Select(string ConnectionString, string SqlText, params object[] Params) => Select(ConnectionString, SqlText, SysConfig.DefaultCommandTimeoutSeconds, Params);
    /// <summary>
    /// Executes a SELECT statement and returns the result as a DataTable.
    /// </summary>
    public DataTable Select(string ConnectionString, string SqlText, int CommandTimeout, params object[] Params)
    {
    ...
    /// </summary>
    public DataTable Select(DbTransaction Transaction, string SqlText, int CommandTimeout, params object[] Params)
    {
        DataTable Table = new DataTable();
        SelectTo(Transaction, Table, SqlText, CommandTimeout, Params);
        return Table;
    ...
    /// </summary>
    public int SelectTo(DbConnectionInfo ConnectionInfo, DataTable Table, string SqlText) => SelectTo(ConnectionInfo, Table, SqlText, null);
    /// <summary>
    /// Executes a SELECT statement and loads the result into the specified DataTable.
    /// </summary>
    public int SelectTo(DbConnectionInfo ConnectionInfo, DataTable Table, string SqlText, params object[] Params) => SelectTo(ConnectionInfo.ConnectionString, Table, SqlText, ConnectionInfo.CommandTimeoutSeconds, Params);
 
    /// <summary>
    /// Executes a SELECT statement and loads the result into the specified DataTable.
    /// </summary>
    public int SelectTo(string ConnectionString, DataTable Table, string SqlText, params object[] Params) => SelectTo(ConnectionString, Table, SqlText, SysConfig.DefaultCommandTimeoutSeconds, Params);
    /// <summary>
    /// Executes a SELECT statement and loads the result into the specified DataTable.
    /// </summary>
    public int SelectTo(string ConnectionString, DataTable Table, string SqlText, int CommandTimeout, params object[] Params)
    {
        using (DbConnection Connection = CreateConnection(ConnectionString))
        {
            Connection.Open();
    ...
    /// </summary>
    public int SelectTo(DbTransaction Transaction, DataTable Table, string SqlText, int CommandTimeout, params object[] Params)
    {
