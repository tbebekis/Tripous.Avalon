...
public class DataModule
{
    ...
    // ● list
    public virtual async Task ListSelect(SelectDef SelectDef)
    {
        if (SelectDef != null)
        {
            MemTable tblSource =  await Link.Select(ModuleDef, SelectDef);
            tblList.CopyFrom(tblSource);
        }
    }
    ...
    // ● properties
    public IDataLink Link => Links.Data;
    ...
    public MemTable tblLines { get; set; }
    public MemTable tblSubLines { get; set; }
