...
/// <summary>
/// Provides indexed row and field value access for a pivot grid data source.
/// </summary>
public interface IPivotGridDataAdapter
{
    // ● public methods
    /// <summary>
    ...
    /// </summary>
    IReadOnlyList<PivotGridSourceField> SourceFields { get; }

    // ● events
    /// <summary>
    /// Occurs when rows or field values exposed by the adapter change.
    /// </summary>
    event EventHandler<PivotGridDataChangedEventArgs> Changed;
}
