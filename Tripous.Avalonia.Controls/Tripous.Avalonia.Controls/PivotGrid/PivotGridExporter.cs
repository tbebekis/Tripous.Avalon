...
/// <summary>
/// Base class for pivot grid exporters.
/// </summary>
public abstract class PivotGridExporter
{
    // ● protected methods
    /// <summary>
    ...
    // ● public methods
    /// <summary>
    /// Exports a pivot grid snapshot.
    /// </summary>
    /// <param name="Grid">The source pivot grid.</param>
    /// <param name="Snapshot">The export snapshot.</param>
    /// <param name="FilePath">The export file path.</param>
    public abstract void Export(PivotGrid Grid, PivotGridExportSnapshot Snapshot, string FilePath);
