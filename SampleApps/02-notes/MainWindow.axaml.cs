...
public partial class MainWindow : Window
{
    ...
    private void CreateMenu()
    {
        ...
        MenuItem NotesItem = new() { Header = "_Notes" };
        NotesItem.Click += (Sender, Args) => ShowNotes();
    ...
    private void UpdateStatusBar(string Message)
    {
        ...
        lblDetails.Text = "Notes v1.0";
    }
    /// <summary>
    /// Shows the Note data form.
    /// </summary>
    private void ShowNotes()
    {
        AppHost.ContentHandler.ShowDataForm("Note");
        UpdateStatusBar("Notes form opened.");
    }
    /// <summary>
