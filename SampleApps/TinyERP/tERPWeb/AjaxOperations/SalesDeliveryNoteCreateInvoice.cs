...
/// <summary>
/// Creates a Sales Invoice data module from a Sales Delivery Note data module.
/// </summary>
[AjaxOperation("App.SalesDeliveryNote.CreateInvoice")]
public class SalesDeliveryNoteCreateInvoice: DataModuleAjaxOperation
{
    // ● public
    /// <summary>
    ...
    public override AjaxResponse Execute(AjaxRequest Request, AjaxOperationContext Context)
    {
        ...
        Result["WebFormName"] = "SalesInvoice";
