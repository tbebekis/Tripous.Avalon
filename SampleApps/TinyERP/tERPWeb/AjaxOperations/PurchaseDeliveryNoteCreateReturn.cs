...
/// <summary>
/// Creates a Purchase Return data module from a Purchase Delivery Note data module.
/// </summary>
[AjaxOperation("App.PurchaseDeliveryNote.CreateReturn")]
public class PurchaseDeliveryNoteCreateReturn: DataModuleAjaxOperation
{
    // ● public
    /// <summary>
    ...
    public override AjaxResponse Execute(AjaxRequest Request, AjaxOperationContext Context)
    {
        ...
        Result["WebFormName"] = "PurchaseReturn";
