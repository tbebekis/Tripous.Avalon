...
/// <summary>
/// Creates a Sales Credit Note data module from a Sales Invoice data module.
/// </summary>
[AjaxOperation("App.SalesInvoice.CreateCreditNote")]
public class SalesInvoiceCreateCreditNote: DataModuleAjaxOperation
{
    // ● public
    /// <summary>
    ...
    public override AjaxResponse Execute(AjaxRequest Request, AjaxOperationContext Context)
    {
        ...
        Result["WebFormName"] = "SalesCreditNote";
