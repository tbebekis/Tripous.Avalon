...
public partial class MainWindow : Window
{
    ...
    private void CreateMenu()
    {
        ...
        MenuItem ToDoItem = new() { Header = "_ToDo" };
        ToDoItem.Click += (Sender, Args) => ShowToDo();
    ...
    private void UpdateStatusBar(string Message)
    {
        ...
        lblDetails.Text = "ToDo v1.0";
    }
    /// <summary>
    /// Shows the TodoTask data form.
    /// </summary>
    private void ShowToDo()
    {
        AppHost.ContentHandler.ShowDataForm("TodoTask");
        UpdateStatusBar("ToDo form opened.");
    }
    /// <summary>
