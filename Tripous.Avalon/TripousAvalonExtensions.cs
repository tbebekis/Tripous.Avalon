...
static public class TripousAvalonExtensions
{
    ...
    /*
    static public MenuItem AddMenuItem(this ItemCollection Items, string Header)
    {
        EventHandler<RoutedEventArgs> Click = null;
        return AddMenuItem(Items, Header, Click);
    }
    static public MenuItem AddMenuItem(this ItemCollection Items, string Header, EventHandler<RoutedEventArgs> Click)
    {
        object Tag = null;
        return AddMenuItem(Items, Header, Click, Tag);
    }
    static public MenuItem AddMenuItem(this ItemCollection Items, string Header, EventHandler<RoutedEventArgs> Click, object Tag)
    {
        MenuItem Result = new MenuItem() { Header =  Header, Tag = Tag };
        Result.Click += Click;
        Items.Add(Result);
    ...
    static public MenuItem AddMenuItem(this ItemCollection Items, string Header, Action Action)
    {
        object Tag = null;
        return AddMenuItem(Items, Header, Action, Tag);
    }
    static public MenuItem AddMenuItem(this ItemCollection Items, string Header, Action Action, object Tag)
    {
        MenuItem Result = new MenuItem() { Header =  Header, Tag = Tag };
        if (Action != null)
            Result.Click += (sender, args) => Action();
    ...
    */
    ...
    /*
    static public MenuItem AddCheckBoxMenuItem(this ItemCollection Items, string Header, bool IsChecked, Action Action, object Tag)
    {
        MenuItem Result = new();
        Result.Header = Header;
        Result.Tag = Tag;
    ...
    static public MenuItem AddCheckBoxMenuItem(this IList<object> Items, string Header, bool IsChecked, Action Action , object Tag = null)
    {
        MenuItem Result = new();
        Result.Header = Header;
        Result.Tag = Tag;
